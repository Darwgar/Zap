...
uint256 hashGenesisBlock("0xad385ec2c176e150ffc1e1aff2dde566ffce15e4db10c0eb98b7e7e20da786e0");
...
const string strMessageMagic = "ZapCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 4 * 60; // ZapCoin: 0.35 days    // TIEMPO EN REAJSUTAR LA DIFICULTAD DE LA MINERIA / ES PROPORCIONAL AL NUMERO DE MONEDAS EXISTENTES
static const int64 nTargetSpacing = 30; // ZapCoin: 10 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal ZapCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ZapCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	CBlock(hash=14dc23f54de47df79717, PoW=00000aeb1f05fbf0b2fa, ver=1, 			hashPrevBlock=00000000000000000000, hashMerkleRoot=ef7e256a2c, 			nTime=1399574511, nBits=1e0ffff0, nNonce=2086299649, vtx=1)
  	...
  	vMerkleTree: ef7e256a2c */
        ...
        // Genesis block
        const char* pszTimestamp = "primer dia de ZapCoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1511023796;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2088193952;
        ...
        assert(block.hashMerkleRoot == uint256("0xb795d154123cb57ef289cbb11fc508dfc1e133ea60486d9baadde29306928a37"));
